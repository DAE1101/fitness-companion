  ...
  const WORKOUT_ROUTINES = {
    "Chest & Triceps": {
      ...
      exercises:[
        ...
        {name:"Overhead Tricep Extension", sets:3, reps:"10–12",rest:"90s",  muscle:"Triceps",  tip:"Keep elbows close to head, full range of motion",                   img:"/exercises/tricep-extension.gif"},
        {name:"Diamond Push-Ups",          sets:3, reps:"To failure",rest:"60s",muscle:"Triceps",tip:"Hands form a diamond shape, keep core tight",                     img:"/exercises/diamond-pushup.gif"},
      ]
    },
    "Back & Biceps": {
      color:"#0097a7", emoji:"🏋️",
      exercises:[
        {name:"Pull-Ups / Lat Pulldown",   sets:4, reps:"6–8",  rest:"3 min", muscle:"Lats",     tip:"Full hang at bottom, pull elbows to hips",                         img:"/exercises/lat-pulldown.gif"},
        {name:"Barbell Bent Over Row",     sets:4, reps:"8–10", rest:"2 min", muscle:"Back",     tip:"Hinge at hips 45°, pull bar to lower chest",                       img:"/exercises/bent-over-row.gif"},
        {name:"Seated Cable Row",          sets:3, reps:"10–12",rest:"90s",  muscle:"Mid Back",  tip:"Sit tall, pull to belly button, squeeze shoulder blades",           img:"/exercises/cable-row.gif"},
        {name:"Single Arm Dumbbell Row",   sets:3, reps:"10–12",rest:"90s",  muscle:"Lats",     tip:"Support on bench, pull elbow past hip",                             img:"/exercises/dumbbell-row.gif"},
        {name:"Barbell Curl",              sets:3, reps:"8–10", rest:"90s",  muscle:"Biceps",   tip:"Elbows stay at sides, squeeze at top",                              img:"/exercises/barbell-curl.gif"},
        {name:"Hammer Curl",               sets:3, reps:"10–12",rest:"60s",  muscle:"Biceps",   tip:"Neutral grip, alternate arms for control",                          img:"/exercises/hammer-curl.gif"},
      ]
    },
    "Legs": {
      color:"#f9a825", emoji:"🦵",
      exercises:[
        {name:"Barbell Back Squat",        sets:4, reps:"6–8",  rest:"3 min", muscle:"Quads/Glutes",tip:"Feet shoulder width, chest up, knees track over toes",         img:"/exercises/squat.gif"},
        {name:"Romanian Deadlift",         sets:4, reps:"8–10", rest:"2 min", muscle:"Hamstrings", tip:"Soft knee bend, push hips back, bar stays close to legs",        img:"/exercises/rdl.gif"},
        {name:"Leg Press",                 sets:3, reps:"10–12",rest:"2 min", muscle:"Quads",      tip:"Feet hip width, don't lock knees at top",                        img:"/exercises/leg-press.gif"},
        {name:"Walking Lunges",            sets:3, reps:"12 each",rest:"90s", muscle:"Quads/Glutes",tip:"Step forward, back knee grazes floor, stay upright",            img:"/exercises/lunges.gif"},
        {name:"Leg Curl",                  sets:3, reps:"12–15",rest:"90s",  muscle:"Hamstrings", tip:"Control the negative, full range of motion",                      img:"/exercises/leg-curl.gif"},
        {name:"Standing Calf Raise",       sets:4, reps:"15–20",rest:"60s",  muscle:"Calves",     tip:"Full stretch at bottom, pause at top",                            img:"/exercises/calf-raise.gif"},
      ]
    },
    "Shoulders": {
      color:"#8e24aa", emoji:"🏅",
      exercises:[
        {name:"Overhead Press",            sets:4, reps:"6–8",  rest:"3 min", muscle:"Shoulders",  tip:"Bar at chin level, press straight up, lock out at top",          img:"/exercises/overhead-press.gif"},
        {name:"Lateral Raise",             sets:4, reps:"12–15",rest:"60s",  muscle:"Side Delts",  tip:"Slight bend in elbows, raise to shoulder height only",            img:"/exercises/lateral-raise.gif"},
        {name:"Front Raise",               sets:3, reps:"12–15",rest:"60s",  muscle:"Front Delts", tip:"Alternate arms, raise to eye level",                             img:"/exercises/front-raise.gif"},
        {name:"Face Pulls",                sets:3, reps:"15–20",rest:"60s",  muscle:"Rear Delts",  tip:"Pull to forehead, elbows high and wide",                         img:"/exercises/face-pulls.gif"},
        {name:"Upright Row",               sets:3, reps:"10–12",rest:"90s",  muscle:"Traps",       tip:"Wide grip, elbows lead the movement",                            img:"/exercises/upright-row.gif"},
        {name:"Arnold Press",              sets:3, reps:"10–12",rest:"90s",  muscle:"Full Shoulder",tip:"Rotate palms as you press, full rotation",                      img:"/exercises/arnold-press.gif"},
      ]
    },
    "Push": {
      color:"#e53935", emoji:"⬆️",
      exercises:[
        {name:"Barbell Bench Press",       sets:4, reps:"6–8",  rest:"3 min", muscle:"Chest",      tip:"Arch back slightly, feet flat, bar to lower chest",              img:"/exercises/bench-press.gif"},
        {name:"Overhead Press",            sets:4, reps:"6–8",  rest:"3 min", muscle:"Shoulders",  tip:"Core tight, press straight up",                                  img:"/exercises/overhead-press.gif"},
        {name:"Incline Dumbbell Press",    sets:3, reps:"8–10", rest:"2 min", muscle:"Upper Chest", tip:"Control the descent, full stretch at bottom",                   img:"/exercises/incline-press.gif"},
        {name:"Lateral Raise",             sets:3, reps:"12–15",rest:"60s",  muscle:"Side Delts",  tip:"Lead with elbows, raise to shoulder height",                     img:"/exercises/lateral-raise.gif"},
        {name:"Tricep Rope Pushdown",      sets:3, reps:"10–12",rest:"90s",  muscle:"Triceps",     tip:"Elbows pinned, fully extend at bottom",                          img:"/exercises/tricep-pushdown.gif"},
        {name:"Overhead Tricep Extension", sets:3, reps:"10–12",rest:"90s",  muscle:"Triceps",     tip:"Keep elbows close to ears",                                      img:"/exercises/tricep-extension.gif"},
      ]
    },
    "Pull": {
      color:"#0097a7", emoji:"⬇️",
      exercises:[
        {name:"Pull-Ups / Lat Pulldown",   sets:4, reps:"6–8",  rest:"3 min", muscle:"Lats",       tip:"Dead hang start, drive elbows to hips",                          img:"/exercises/lat-pulldown.gif"},
        {name:"Barbell Bent Over Row",     sets:4, reps:"8–10", rest:"2 min", muscle:"Back",        tip:"45° hinge, pull to lower chest",                                 img:"/exercises/bent-over-row.gif"},
        {name:"Face Pulls",               sets:3, reps:"15–20", rest:"60s",  muscle:"Rear Delts",  tip:"Pull to forehead level, elbows high",                            img:"/exercises/face-pulls.gif"},
        {name:"Seated Cable Row",          sets:3, reps:"10–12",rest:"90s",  muscle:"Mid Back",    tip:"Tall spine, squeeze shoulder blades",                             img:"/exercises/cable-row.gif"},
        {name:"Barbell Curl",              sets:3, reps:"8–10", rest:"90s",  muscle:"Biceps",      tip:"No swinging, squeeze at top",                                    img:"/exercises/barbell-curl.gif"},
        {name:"Hammer Curl",               sets:3, reps:"10–12",rest:"60s",  muscle:"Biceps",      tip:"Neutral grip targets brachialis",                                img:"/exercises/hammer-curl.gif"},
      ]
    },
    "Full Body": {
      color:"#43a047", emoji:"⚡",
      exercises:[
        {name:"Barbell Back Squat",        sets:3, reps:"8–10", rest:"2 min", muscle:"Quads/Glutes",tip:"Full depth, chest up throughout",                               img:"/exercises/squat.gif"},
        {name:"Barbell Bench Press",       sets:3, reps:"8–10", rest:"2 min", muscle:"Chest",       tip:"Control down, explosive press up",                              img:"/exercises/bench-press.gif"},
        {name:"Barbell Bent Over Row",     sets:3, reps:"8–10", rest:"2 min", muscle:"Back",        tip:"Pull to belly button, squeeze at top",                          img:"/exercises/bent-over-row.gif"},
        {name:"Overhead Press",            sets:3, reps:"8–10", rest:"2 min", muscle:"Shoulders",   tip:"Press straight up, full lockout",                               img:"/exercises/overhead-press.gif"},
        {name:"Romanian Deadlift",         sets:3, reps:"10–12",rest:"2 min", muscle:"Hamstrings",  tip:"Feel the hamstring stretch, controlled descent",                img:"/exercises/rdl.gif"},
        {name:"Plank",                     sets:3, reps:"45–60s",rest:"60s", muscle:"Core",         tip:"Neutral spine, squeeze glutes and abs",                          img:"/exercises/plank.gif"},
      ]
    },
    "Upper Body": {
      color:"#1a7fe8", emoji:"💪",
      exercises:[
        {name:"Barbell Bench Press",       sets:4, reps:"8–10", rest:"2 min", muscle:"Chest",       tip:"Full range of motion, control the descent",                     img:"/exercises/bench-press.gif"},
        {name:"Pull-Ups / Lat Pulldown",   sets:4, reps:"8–10", rest:"2 min", muscle:"Lats",        tip:"Retract shoulder blades at top",                                img:"/exercises/lat-pulldown.gif"},
        {name:"Overhead Press",            sets:3, reps:"8–10", rest:"2 min", muscle:"Shoulders",   tip:"Brace core throughout the press",                               img:"/exercises/overhead-press.gif"},
        {name:"Seated Cable Row",          sets:3, reps:"10–12",rest:"90s",  muscle:"Mid Back",     tip:"Drive elbows back, squeeze at end",                             img:"/exercises/cable-row.gif"},
        {name:"Lateral Raise",             sets:3, reps:"12–15",rest:"60s",  muscle:"Side Delts",   tip:"Slow and controlled, no swinging",                              img:"/exercises/lateral-raise.gif"},
        {name:"Barbell Curl",              sets:3, reps:"10–12",rest:"60s",  muscle:"Biceps",       tip:"Supinate wrist at top for peak contraction",                    img:"/exercises/barbell-curl.gif"},
      ]
    },
    "Lower Body": {
      color:"#f9a825", emoji:"🦵",
      exercises:[
        {name:"Barbell Back Squat",        sets:4, reps:"8–10", rest:"2 min", muscle:"Quads/Glutes",tip:"Sit back and down, drive through heels",                        img:"/exercises/squat.gif"},
        {name:"Romanian Deadlift",         sets:4, reps:"8–10", rest:"2 min", muscle:"Hamstrings",  tip:"Hinge at hips, feel the stretch",                               img:"/exercises/rdl.gif"},
        {name:"Leg Press",                 sets:3, reps:"12–15",rest:"90s",  muscle:"Quads",        tip:"Feet hip width, press through heels",                            img:"/exercises/leg-press.gif"},
        {name:"Glute Bridge",              sets:3, reps:"15–20",rest:"60s",  muscle:"Glutes",       tip:"Drive hips up, squeeze glutes at top",                           img:"/exercises/glute-bridge.gif"},
        {name:"Leg Curl",                  sets:3, reps:"12–15",rest:"60s",  muscle:"Hamstrings",   tip:"Control the negative, full range",                               img:"/exercises/leg-curl.gif"},
        {name:"Standing Calf Raise",       sets:3, reps:"15–20",rest:"60s",  muscle:"Calves",       tip:"Full stretch at bottom, pause at top",                           img:"/exercises/calf-raise.gif"},
      ]
    },
    "HIIT Circuit": {
      color:"#e53935", emoji:"🔥",
      exercises:[
        {name:"Jump Squats",               sets:4, reps:"40s",  rest:"20s",  muscle:"Full Body",    tip:"Soft landing, chest up, explode upward",                         img:"/exercises/squat.gif"},
        {name:"Mountain Climbers",         sets:4, reps:"40s",  rest:"20s",  muscle:"Core/Cardio",  tip:"Hips level, drive knees to chest",                               img:"/exercises/mountain-climbers.gif"},
        {name:"Burpees",                   sets:4, reps:"40s",  rest:"20s",  muscle:"Full Body",    tip:"Control the floor transition, explode up",                       img:"/exercises/burpees.gif"},
        {name:"High Knees",                sets:4, reps:"40s",  rest:"20s",  muscle:"Cardio/Core",  tip:"Drive knees to hip height, pump arms",                           img:"/exercises/high-knees.gif"},
        {name:"Lateral Shuffles",          sets:4, reps:"40s",  rest:"20s",  muscle:"Legs/Agility", tip:"Stay low throughout, don't stand up between shuffles",           img:"/exercises/lateral-shuffles.gif"},
        {name:"Plank to Push-Up",          sets:4, reps:"40s",  rest:"20s",  muscle:"Core/Chest",   tip:"Don't let hips rotate, alternate lead hand",                    img:"/exercises/plank.gif"},
      ]
    },
  };
